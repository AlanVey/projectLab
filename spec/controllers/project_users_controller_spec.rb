...
describe ProjectUsersController do
  ...
  describe "GET show" do
    it "assigns the requested project_user as @project_user" do
      project_user = ProjectUser.create! valid_attributes
      get :show, {:id => project_user.to_param}, valid_session
  ...
  describe "GET edit" do
    it "assigns the requested project_user as @project_user" do
      project_user = ProjectUser.create! valid_attributes
      get :edit, {:id => project_user.to_param}, valid_session
      assigns(:project_user).should eq(project_user)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new ProjectUser" do
        expect {
          post :create, {:project_user => valid_attributes}, valid_session
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved project_user as @project_user" do
        ...
        post :create, {:project_user => { "email" => "invalid value" }}, valid_session
        assigns(:project_user).should be_a_new(ProjectUser)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested project_user" do
        ...
        ProjectUser.any_instance.should_receive(:update).with({ "email" => "MyString" })
        put :update, {:id => project_user.to_param, :project_user => { "email" => "MyString" }}, valid_session
      end

      it "assigns the requested project_user as @project_user" do
        project_user = ProjectUser.create! valid_attributes
        put :update, {:id => project_user.to_param, :project_user => valid_attributes}, valid_session
        assigns(:project_user).should eq(project_user)
      end
    ...
    describe "with invalid params" do
      it "assigns the project_user as @project_user" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ProjectUser.any_instance.stub(:save).and_return(false)
        put :update, {:id => project_user.to_param, :project_user => { "email" => "invalid value" }}, valid_session
        assigns(:project_user).should eq(project_user)
      end
  ...
  describe "DELETE destroy" do
    it "destroys the requested project_user" do
      project_user = ProjectUser.create! valid_attributes
      expect {
        delete :destroy, {:id => project_user.to_param}, valid_session
      }.to change(ProjectUser, :count).by(-1)
    end
